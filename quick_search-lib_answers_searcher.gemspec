...
Gem::Specification.new do |s|
  ...
  s.version     = QuickSearchLibAnswersSearcher::VERSION
  s.authors     = ['UMD Libraries']
  s.email       = ['lib-ssdr@umd.edu']
  s.homepage    = 'https://www.lib.umd.edu/'
  s.summary     = 'LibAnswers searcher for NCSU Quick Search'
  s.description = 'LibAnswers searcher for NCSU Quick Search.'
